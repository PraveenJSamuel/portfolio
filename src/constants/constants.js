export const projects = [
  {
    ...
    visit: 'https://memories-app-jcx4.onrender.com',
    id: 0,
  },
  {
    title: 'TechNotes',
    description: "An easy to use customer note tracking application for a tech repair shop. This app lets employees login and access their assigned notes which track the customer and issue they are currently working on. It also supports user authentication and authorization to allow different employee roles such as managers, and restricting app features to those roles.",
    image: '/images/2.png',
    tags: ['Mongo', 'Express', 'React', 'Node'],
    source: 'https://github.com/PraveenJSamuel/techNotesFE',
    visit:  'https://technotes-yv1l.onrender.com',
    id: 1,
  },
  {
    ...
    visit: 'https://thegymlibrary.onrender.com',
    id: 2,
  },
];
